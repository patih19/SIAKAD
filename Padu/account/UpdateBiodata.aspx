    ...
    <div class="container top-main-form" style="background: #fafafa">
        ...
        <div class="row">
            ...
            <div class="list-group">
                ...
                <a href="<%= Page.ResolveUrl("~/account/biodata.aspx") %>"
            ...
            <div class="list-group">
                ...
                <a href="<%= Page.ResolveUrl("~/account/KRS.aspx") %>" class="list-group-item"><span
                    class="glyphicon glyphicon-check"></span>&nbsp;KRS</a>
                <a href="<%= Page.ResolveUrl("~/account/KHS.aspx") %>" class="list-group-item"><span
                    class="glyphicon glyphicon-file"></span>&nbsp;KHS</a> 
                <a href="<%= Page.ResolveUrl("~/account/KartuUjian.aspx") %>" class="list-group-item"><span
                    class="glyphicon glyphicon-file"></span>&nbsp;Kartu Ujian</a> 
            </div>
            <div class="list-group">
                <a href="#" class="list-group-item" style="background-color: #87cefa">SYSTEM</a>
                <a href="<%= Page.ResolveUrl("~/account/upload.aspx") %>" class="list-group-item"><span
