<%@ Page Title="" Language="C#" MasterPageFile="~/TU.Master" AutoEventWireup="true" CodeBehind="RekapSKS.aspx.cs" Inherits="Portal.WebForm13" %>
            ...
            <br />
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <strong>Rekap Pengambilan SKS Berdasarkan Program Studi</strong></div>
                ...
                <asp:Panel ID="PanelRekapSKS" runat="server">
                    <div class="panel panel-default">
                        <div class="panel-heading ui-draggable-handle">
                            <strong>Daftar Pengambilan SKS</strong></div>
                        <div class="panel-body">
                            <table class="table-condensed">
                                <tr>
                                    <td>
                            ...
                            <br />
                            <asp:GridView ID="GVRekapSKS" runat="server" CellPadding="4" 
