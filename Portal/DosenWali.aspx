<%@ Page Title="" Language="C#" MasterPageFile="~/TU.Master" AutoEventWireup="true" CodeBehind="DosenWali.aspx.cs" Inherits="Portal.WebForm26" %>
                    ...
                    <ItemTemplate>
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                ...
                                <strong>
                                    <asp:Label ID="LbHari" runat="server" Text='<%# Eval("Hari") %>'></asp:Label></strong>
                            </div>
                            <div class="panel-body">
