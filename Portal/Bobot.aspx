<%@ Page Title="" Language="C#" MasterPageFile="~/TU.Master" AutoEventWireup="true" CodeBehind="Bobot.aspx.cs" Inherits="Portal.WebForm17" %>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <strong>Bobot Nilai</strong></div>
                    <div class="panel-body">
                                <asp:GridView ID="GVBobot" runat="server" CellPadding="4" 
