...
namespace Portal
{
   //public partial class ListNilai : System.Web.UI.Page
    public partial class ListNilai : Tu
    {
                ...
                if (lastpage is WebForm14)
                {
                    try
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(CS))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@no_jadwal", ((WebForm14)lastpage).NoJadwal);
                ...
                else if (lastpage is WebForm15)
                {
                    try
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(CS))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand("SpGetNilaiByJadwal", con);
                            cmd.CommandType = System.Data.CommandType.StoredProcedure;
                            cmd.Parameters.AddWithValue("@no_jadwal", ((WebForm15)lastpage).NoJadwal);
