<%@ Page Title="" Language="C#" MasterPageFile="~/am/admin.Master" AutoEventWireup="true" CodeBehind="FAktvMhs.aspx.cs" Inherits="akademik.am.WebForm39" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        table#ctl00_ContentPlaceHolder1_GVAktvMhs tr:hover { background-color: #d9edf7;}
        th{ color: White !important; background-color: rgb(51, 123, 102);}
        table#ctl00_ContentPlaceHolder1_GVAktvMhs tbody tr:nth-child(odd) { background-color: #fff;}
        table#ctl00_ContentPlaceHolder1_GVAktvMhs tbody tr:nth-child(odd){ background-color: #EEF7EE;}
    </style>
</asp:Content>
                ...
                <div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading ui-draggable-handle">
                            <strong>Aktivitas Perkuliahan Mahasiswa (FEEDER)</strong></div>
                        ...
                        <div class="panel-footer">
                            &nbsp;<asp:Button ID="BtnAktvMhs" runat="server" Text="OK" OnClick="BtnAktvMhs_Click"
                                CssClass="btn btn-primary" />
                            <asp:Label ID="LbBtnAktvMhsResult" runat="server"></asp:Label>
                        </div>
                    </div>
                    <asp:Panel ID="PanelAktvMhs" runat="server">
                        <hr />
                        <div class="panel panel-default">
                            <div class="panel-heading ui-draggable-handle">
                                Daftar Aktivitas Perkuliahan Mahasiswa</div>
                            <div class="panel-body">
                                <div class="box">
                                    <div class="box-body table-responsive">
                                        <asp:GridView ID="GVAktvMhs" runat="server" CssClass="table table-bordered table-condensed"
