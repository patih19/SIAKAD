<%@ Page Title="" Language="C#" MasterPageFile="~/am/admin.Master" AutoEventWireup="true" CodeBehind="Mahasiswa.aspx.cs" Inherits="akademik.am.WebForm20" EnableEventValidation="false" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table-condensed">
                                <tr>
                                    <td class="style4">
                                        <strong>Program Studi</strong></td>
                                    <td>
                                        </td>
                                        <td class="style4" ><strong>Angkatan</strong></td>
                                        <td class="style4" ><strong>Gender</strong></td>
                                        <td class="style4" ><strong>Agama</strong></td>
                                        <td ></td>
                                        <td class="style4" colspan="2" ><strong>Daerah</strong></td>
                                        <td></td>
                                        <td class="style4" ><strong>Nama / NPM</strong></td>
                                </tr>
                                <tr>
                                    <td class="style4">
                                    ...
                                    <td class="style4">
                                        <asp:TextBox ID="TbAngkatan" runat="server" CssClass="form-control" 
                                            MaxLength="9" Placeholder="ex: 2015/2016" AutoPostBack="True" 
                                            ontextchanged="TbAngkatan_TextChanged" ></asp:TextBox>
                                    </td>
                                    <td class="style4">
                                        <asp:DropDownList CssClass="form-control" ID="DLSex" runat="server" 
                                            AutoPostBack="True" onselectedindexchanged="DLSex_SelectedIndexChanged">
                                    ...
                                    <td class="style4">
                                        <asp:DropDownList CssClass="form-control" ID="DLReligi" runat="server" 
                                            AutoPostBack="True" onselectedindexchanged="DLReligi_SelectedIndexChanged">
                                    ...
                                    <td class="style4" >
                                        <asp:DropDownList ID="DLKotaKab" runat="server" CssClass="form-control" 
                                            AutoPostBack="True" onselectedindexchanged="DLKotaKab_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    ...
                                    <td class="style4" >
                                        <asp:TextBox CssClass="form-control" MaxLength="20" ID="TbSrcNama" 
                                            runat="server" Placeholder="Min 4 huruf" AutoPostBack="True" 
                                            ontextchanged="TbSrcNama_TextChanged"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
