<%@ Page Title="" Language="C#" MasterPageFile="~/am/admin.Master" AutoEventWireup="true" CodeBehind="JadwalMku.aspx.cs" Inherits="akademik.am.WebForm45" EnableEventValidation="false" %>
            ...
            <div class="col-xs-12 col-md-12 col-lg-12">
                    ...
                    <div class="panel-body">
                        <table class="table-condensed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="BtnJadwal" runat="server" Text="OK" OnClick="BtnJadwal_Click" CssClass="btn btn-success" />
                ...
                <div>
                    ...
                    <asp:Panel ID="PanelJadwal" runat="server">
                        <div class="panel panel-default">
                            <div class="panel-heading ui-draggable-handle">
                                <strong>List Jadwal Perkuliahan</strong> &nbsp;<asp:Button ID="BtnNewJadwal" OnClick="BtnNewJadwal_Click"
                                    runat="server" CssClass="btn btn-danger" Text="Buat Jadwal" />
                            </div>
                            <div class="panel-body">
                                <asp:GridView ID="GVJadwal" runat="server" CssClass="table table-condensed table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="TbQuota" runat="server" AutoPostBack="True" CssClass="from-control"
                                                    MaxLength="2" OnTextChanged="TbQuota_TextChanged" Width="35px"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                        ...
                                        <asp:UpdatePanel ID="UpPnlAjaxJadwal" runat="server">
                                            <ContentTemplate>
                                                <table class="table-bordered table-condensed table">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div style="padding-left: 7px">
                                                                <asp:Label CssClass="hidden" ID="LbKodeMakul" runat="server" Font-Size="Medium" ForeColor="#333399"
                                                                    Style="font-size: 12px"></asp:Label>
                                                                <asp:Label ID="LbMakul" runat="server" Font-Size="Medium" ForeColor="#333399" Style="font-size: 12px"></asp:Label>
                                                                <asp:Label CssClass="hidden" ID="LbProdi" runat="server" Font-Size="Medium" ForeColor="Transparent"
                                                                    Style="font-size: 12px"></asp:Label>
                                                            </div>
                                                            <p>
                                                            </p>
                                                    ...
                                                    <tr>
                                                        <td style="background-color: #E1F0FF; padding-left: 10px">
                                                            <strong>RUANG KULIAH</strong>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div style="padding-left: 7px">
                                                                <asp:Label ID="LbRuang" runat="server" Font-Size="Medium" ForeColor="#333399" Style="font-size: 12px"></asp:Label>
                                                            ...
                                                            <asp:Panel ID="PanelRuang" runat="server">
                                                                <table class="table-condensed">
                                                                    <tr>
                                                                        <td>
                                                                            <asp:DropDownList ID="DLRuangProdi" runat="server" AutoPostBack="True" CssClass="form-control"
                                                                ...
                                                                <asp:Panel ID="PanelDetailRuang" runat="server">
                                                                    <table class="table-condensed">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="GVRuang" runat="server" CellPadding="4" CssClass="table-condensed table-bordered"
                                                                                    ForeColor="#333333" GridLines="None" OnRowDataBound="GVRuang_RowDataBound">
                                                                                    <AlternatingRowStyle BackColor="White" />
                                                                                    <Columns>
                                                                                        <asp:TemplateField>
                                                                                            <ItemTemplate>
                                                                                                <asp:CheckBox ID="CbRuang" runat="server" AutoPostBack="True" OnCheckedChanged="CbRuang_CheckedChanged" />
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                    </Columns>
                                                                                    <EditRowStyle BackColor="#7C6F57" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="padding-top: 5px; padding-left: 6px">
                                                                        <asp:DropDownList ID="DLHari" runat="server" CssClass="form-control" Width="90px"
                                                                            OnSelectedIndexChanged="DLHari_SelectedIndexChanged" AutoPostBack="True">
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 10px; padding-left: 10px">
                                                            <asp:TextBox ID="TbMulai" runat="server" CssClass="form-control" MaxLength="5" Width="90px"></asp:TextBox>
                                                            <p>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="padding-top: 10px; padding-left: 10px">
                                                            <asp:TextBox ID="TbSelesai" runat="server" CssClass="form-control" MaxLength="5"
