<%@ Page Title="" Language="C#" MasterPageFile="~/am/admin.Master" AutoEventWireup="true" CodeBehind="Nilai.aspx.cs" Inherits="akademik.am.WebForm7" EnableEventValidation="false" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Panel ID="PanelProdi" runat="server">
                                ...
                                <br />
                                    <asp:Label runat="server" Style="font-style: italic; font-size: small" Text="pilih salah satu jadwal kuliah"></asp:Label>
