<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Log.aspx.cs" Inherits="akademik.Log" EnableViewStateMac="true" %>
...
<body>
    ...
    <div>
        <section class="container">
            ...
            <div class="login">
                <h1>
                    Login SIM Akademik BAKPK</h1>
                <p>
                    <asp:TextBox ID="TbUser" placeholder="Username Staff BAKPK" runat="server"></asp:TextBox></p>
                <p>
            ...
            <div class="login-help">
                <p>
                    Forgot your password? <a href="index.html">Click here to reset it</a>.</p>
            </div>
        </section>
        <section class="about">
           <!-- <p class="about-links">
            ...
            <p class="about-author">
                &copy; 2014&ndash;2015, TIM IT PUSKOMINFO UNTIDAR</a>
